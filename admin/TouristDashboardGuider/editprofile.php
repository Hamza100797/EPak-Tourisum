                      ...
                      <div class="card">
                        <div class="card-body d-flex ">
                           <div class="mt-4 d-block">
                                ...
                                <img src="TouristGuider_Dashboard/upload/<?php echo$row['image']?>" class="rounded-circle "width="150" height="150px" /> 
                                </div>
...
<script src="TouristGuider_Dashboard/dist/js/adminlte.js"></script>
 <!-- ============================================================== -->
    <!-- All Jquery -->
    <!-- ============================================================== -->
    <script src="TouristGuider_Dashboard/public/touristdashboard_filies/assets/libs/jquery/dist/jquery.min.js"></script>
    <!-- Bootstrap tether Core JavaScript -->
    <script src="TouristGuider_Dashboard/public/touristdashboard_filies/assets/libs/popper.js/dist/umd/popper.min.js"></script>
    <script src="TouristGuider_Dashboard/public/touristdashboard_filies/assets/libs/bootstrap/dist/js/bootstrap.min.js"></script>
    <!-- apps -->
    <script src="TouristGuider_Dashboard/public/touristdashboard_filies/dist/js/app.min.js"></script>
    <script src="TouristGuider_Dashboard/public/touristdashboard_filies/dist/js/app.init.js"></script>
    <script src="TouristGuider_Dashboard/public/touristdashboard_filies/dist/js/app-style-switcher.js"></script>
    <!-- slimscrollbar scrollbar JavaScript -->
    <script src="TouristGuider_Dashboard/public/touristdashboard_filies/assets/libs/perfect-scrollbar/dist/perfect-scrollbar.jquery.min.js"></script>
    <script src="TouristGuider_Dashboard/public/touristdashboard_filies/assets/extra-libs/sparkline/sparkline.js"></script>
    <!--Wave Effects -->
    <script src="TouristGuider_Dashboard/public/touristdashboard_filies/dist/js/waves.js"></script>
    <!--Menu sidebar -->
    <script src="TouristGuider_Dashboard/public/touristdashboard_filies/dist/js/sidebarmenu.js"></script>
    <!--Custom JavaScript -->
    <script src="TouristGuider_Dashboard/public/touristdashboard_filies/dist/js/custom.min.js"></script>
</body>
</html>
