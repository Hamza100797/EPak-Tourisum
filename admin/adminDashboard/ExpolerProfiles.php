...
<head>
 ...
 <link rel="stylesheet" href="adminDashboardfilies/public/style/bootstrap_min.css">
  <link rel="stylesheet" href="adminDashboardfilies/public/style/expolrepakistan.css">
...
<section style="font-family: 'Merriweather', serif;">
            ...
            <?php 
             ...
             ?>  
                    <main class="container">   
                        <article class="postcard blue mx-5 " style="margin: 0px 150px;">
                            <a class="postcard__img_link" href="#">
                                  <img class="postcard__img" src="../ExpolrePakistanDashboard/ExpolrePakistanDashboard/upload/<?php echo$row['image']?>" alt="BloggerProfile" />   
                            </a>
                            <div class="postcard__text">
                                <img src="../adminDashboard/adminDashboardfilies/public/assets/images/epaktourisumlogo.jpeg" alt="authorimg" class="authorimg">
                              ...
                              <h1 class="postcard__title blue">
                                ...
                                <li><a href="deleteblogs.php?id=<?php echo$row['post_id'] ?>" data-toggle="tooltip" data-placement="bottom" title="Delete Profile Card" data-original-title="Delete Profile Card" data-abc="true" style="font-size: 64px;"><i class="fas fa-trash text-danger mx-2"></i></a></li> 
                ...
                if(mysqli_num_rows($paginationResult)>0){
                        ...
                        if ($pageNo>1){
                            echo '<li class="page-item"><a class="page-link" href="ExpolerProfiles.php?page='.($pageNo - 1).'">Previous</a></li>';
                        }
                        for($i=1; $i<=$totalpages; $i++){
                          ...
                          echo '<li class='.$active.'> <a href="ExpolerProfiles.php?page='.$i.'"> '.$i.'</a> </li>';
                        }
                        if ($totalpages>$pageNo){
                            echo '<li class="page-item"><a class="page-link" href="ExpolerProfiles.php?page='.($pageNo + 1).'">Next</a></li>';
                        }
                        echo "</ul>";
                }
                ?>
