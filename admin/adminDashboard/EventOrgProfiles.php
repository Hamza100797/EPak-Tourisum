...
<link href="adminDashboardfilies/public/eventOrg_dashboard_files/dist/css/upcomingevents.css" rel="stylesheet">
        ...
        <main class="container px-5">   
            <article class="postcard dark blue">
                <a class="postcard__img_link" href="#">
                    <img class="postcard__img" src="../eventOrg_dash/public/eventOrg_dashboard_files/upload<?php echo$row['image']?>" alt="Image Title" />                  
                </a>
                <div class="postcard__text">
                    ...
                    <p class="postcard__title blue ml-4 pl-3"><a href="#"><?php echo$row['eventorg']?></a></p>
                ...
                if(mysqli_num_rows($paginationResult)>0){
                    ...
                    echo '<nav aria-label="..." class="mx-3 p-2">';
                        ...
                        if ($pageNo>1){
                            echo '<li class="page-item px-1"><a class="page-link" href="EventOrgProfiles.php?page='.($pageNo - 1).'">Previous</a></li>';
                        }
                        for($i=1; $i<=$totalpages; $i++){
                          ...
                          echo '<li class='.$active.' px-1> <a href="EventOrgProfiles.php?page='.$i.'"> '.$i.'</a> </li>';
                        }
                        if ($totalpages>$pageNo){
                            echo '<li class="page-item px-1"><a class="page-link" href="EventOrgProfiles.php?page='.($pageNo + 1).'">Next</a></li>';
                        }
                        echo "</ul>";
                        echo '</nav>';
                }
