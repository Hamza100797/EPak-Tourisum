...
<div class="wrapper">
  ...
  <div id="admin-content">
      <div class="container">
          <div class="row">
              <div class="col-md-10">
                  <h1 class="admin-heading">All Blogger Data</h1>
              </div>
              <div class="col-md-12">
              ...
              $sqlrecord="SELECT * FROM users  WHERE role='Blogger' ORDER BY user_id DESC LIMIT {$offset},{$limit} ";
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">All Bloggers</h4>
      ...
      <?php while($row = mysqli_fetch_assoc( $recordResult)) {?>
         ...
         <?php } ?>
                ...
                $sqlpagination="SELECT * FROM users WHERE role='Blogger'";
