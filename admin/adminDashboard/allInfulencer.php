...
<div class="wrapper">
  ...
  <div id="admin-content">
      <div class="container">
          <div class="row">
              <div class="col-md-10">
                  <h1 class="admin-heading">All Infulencer</h1>
              </div>
              <div class="col-md-12">
              ...
              <?php 
               $conn = mysqli_connect("localhost","root","","epaktourism") or die("Connection Failed:" .mysqli_connect_error());
                ...
                $sqlrecord="SELECT * FROM users WHERE role ='Infulencer' ORDER BY user_id DESC LIMIT {$offset},{$limit}";
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">All Infulencer</h4>
      ...
      <?php while($row = mysqli_fetch_assoc( $recordResult)) {?>
         ...
         <?php } ?>
                ...
                $sqlpagination="SELECT * FROM users WHERE role ='Infulencer' ";
