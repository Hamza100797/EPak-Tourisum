            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-body">
                                <center class="mt-4 p-3 mb-3"> <img src="public/touristdashboard_filies/upload/<?php echo$row['image']?>" class="rounded-circle"
                                        width="150" height="150px"  />
                                    <h4 class="card-title mt-2"><?php echo$row['fname']?></h4>
