     ...
     $sqlrecord="SELECT * FROM users WHERE user_id ={$userid}"; 
               ...
               ?>  
                        ...
                        <div class="sidebar">
                            ...
                            <a href="" class="brand-link">
                              <img src="Infulencer_Dashboard/public/assets/images/epaktourisumlogo.jpeg" alt="E-Pakistan logo" class="brand-image img-circle elevation-3" style="opacity: .8">
                              ...
                              <!-- Sidebar user panel (optional) -->
                                <div class="user-panel mt-3 pb-3 mb-3 d-flex w-100 d-flex justify-content-center">
                                  <div class="image ">
                                    <img src="Infulencer_Dashboard/upload/<?php echo$row['image']?>" class="img-circle elevation-2" alt="User Image" style="width: 100px; height: 100px; border-radius: 100%; ">
                                  </div>
      ...
      <nav class="mt-2 form-inline">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="shareStory.php" class="nav-link">
              ...
              <p>Share Your Experience</p>
                    ...
                    <?php 
                     $conn = mysqli_connect("localhost","root","","epaktourism") or die("Connection Failed:" .mysqli_connect_error());
                      $userid=$_SESSION['user']['user_id'];
                        $sqlrecord="SELECT * FROM infulencer WHERE user_id ={$userid}"; 
                      $recordResult = mysqli_query($conn,$sqlrecord) or die("Query failed");
                      ...
                      ?>  
                        ...
                        <li class="nav-item">
                          <a href="stories.php?id=<?php echo$row['influncer_id']?>" class="nav-link">
