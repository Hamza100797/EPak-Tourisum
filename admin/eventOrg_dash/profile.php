            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-body">
                                <center class="mt-5 p-3 mb-5"> <img src="public/eventOrg_dashboard_files/upload/<?php echo$row['image']?>" class="rounded-circle"
                                        width="250" height="250px"  />
                                    <h1 class="card-title mt-5"><?php echo$row['fname']?></h1>
                            ...
                            <div class="card-body"> <small class="text-muted">Email address </small>
                                ...
                                <h6><?php echo$row['phone']?></h6> <small class="text-muted pt-4 db">Address</small>
                                <h6>Tourist</h6>
