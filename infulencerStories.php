...
<!-- infulencer Card -->
<div class="h1 text-center" id="pageHeaderTitle">Shared Stories</div>
          <?php 
                ...
                <div class="postcard__text">
                    ...
                    <div class="postcard__subtitle small">
                        ...
                        <div class="socialicon" >
                            <a href="<?php echo$row['fb']?>" data-toggle="tooltip" data-placement="bottom" title="facebook" data-original-title="facebook" data-abc="true"><i class="fab fa-facebook-f"></i></a>
                            <a href="<?php echo$row['instagram']?> " data-toggle="tooltip" data-placement="bottom" title="instagram" data-original-title="instagram" data-abc="true"><i class="fab fa-instagram"></i></a>
                            <a href="<?php echo$row['youtube']?> " data-toggle="tooltip" data-placement="top" title="youtube" data-original-title="youtube" data-abc="true"><i class="fab fa-youtube"></i></a>
                        </div>
                    </div>
